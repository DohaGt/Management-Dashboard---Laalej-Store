        ...
        <div className={classes.root}>
            ...
            >
                ...
                <Switch>
                    ...
                    <Route path={"/admin/adminhistory"} exact component={AdminhistoryTablePage} />
                    <Route path={"/admin/adminhistory/new"} exact component={AdminhistoryFormPage} />
                    <Route path={"/admin/adminhistory/:id/edit"} exact component={AdminhistoryFormPage} />
                    ...
                    <Route path={"/admin/cashier/new"} exact component={CashierFormPage} />
                    <Route path={"/admin/cashier/:id/edit"} exact component={CashierFormPage} />

                    <Route path={"/admin/client"} exact component={ClientTablePage} />
                    <Route path={"/admin/client/new"} exact component={ClientFormPage} />
                    <Route path={"/admin/client/:id/edit"} exact component={ClientFormPage} />

                    <Route path={"/admin/employee"} exact component={EmployeeTablePage} />
                    <Route path={"/admin/employee/new"} exact component={EmployeeFormPage} />
                    <Route path={"/admin/employee/:id/edit"} exact component={EmployeeFormPage} />

                    <Route path={"/admin/invoice"} exact component={InvoiceTablePage} />
                    <Route path={"/admin/invoice/new"} exact component={InvoiceFormPage} />
                    <Route path={"/admin/invoice/:id/edit"} exact component={InvoiceFormPage} />
                    ...
                    <Route path={"/admin/product/new"} exact component={ProductFormPage} />
                    <Route path={"/admin/product/:id/edit"} exact component={ProductFormPage} />

                    <Route path={"/admin/salesperson"} exact component={SalespersonTablePage} />
                    <Route path={"/admin/salesperson/new"} exact component={SalespersonFormPage} />
                    <Route path={"/admin/salesperson/:id/edit"} exact component={SalespersonFormPage} />
