...
const SupplierTable = () => {
  ...
  const [filters, setFilters] = React.useState([
    {label: 'Company Name', title: 'CompanyName'},{label: 'Contact First Name', title: 'contactFirstName'},{label: 'Contact Last Name', title: 'contactLastName'},{label: 'Phone', title: 'phone'},
          {label: 'Supplier Code', title: 'supplierCode', number: 'true'},{label: 'Zip Code', title: 'zipCode', number: 'true'},
