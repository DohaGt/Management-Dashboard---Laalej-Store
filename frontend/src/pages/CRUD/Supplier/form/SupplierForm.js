        ...
        {(form) => (
          <form onSubmit={form.handleSubmit}>
            <Grid container spacing={3} direction='column'>
              <Grid item>
                <InputFormItem name={'supplierCode'} schema={supplierFields} />
              </Grid>

              <Grid item>
                <InputFormItem name={'CompanyName'} schema={supplierFields} />
              </Grid>
              ...
              <Grid item>
                <InputFormItem name={'phone'} schema={supplierFields} />
              </Grid>

              <Grid item>
                <InputFormItem name={'zipCode'} schema={supplierFields} />
              </Grid>
            </Grid>
