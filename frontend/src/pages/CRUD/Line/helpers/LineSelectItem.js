...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/line/autocomplete`, { params });
  return response.data;
}

const LineSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.line.hasPermissionToCreate,
});

export default connect(select)(LineSelectItem);
