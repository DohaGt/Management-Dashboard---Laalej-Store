...
const ProductTable = () => {
  ...
  const [filters, setFilters] = React.useState([
    ...
    { label: 'Product Code', title: 'productCode', number: 'true' },
    { label: 'Quantity On Hand', title: 'quantityOnHand', number: 'true' },
    {
      label: 'Min Quantity On Hand',
      title: 'minQuantityOnHand',
      number: 'true',
    },
    { label: 'Supplier Code', title: 'supplierCode', number: 'true' },
    { label: 'Price', title: 'price', number: 'true' },
    { label: 'Dicount Rate', title: 'dicountRate', number: 'true' },
  ]);
      ...
      <Widget title={<h4>{humanize('Product')}</h4>} disableWidgetMenu>
        ...
        >
          <DataGrid
            ...
            loading={loading}
            onRowClick={(e) => {
              history.push(`/admin/product/${e.id}/edit`);
            }}
            autoHeight
          />
        </div>
